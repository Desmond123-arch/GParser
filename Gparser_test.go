...
func TestNestingTypesValid(t *testing.T) {
	data, err := os.ReadFile("./step4/valid.json")
	if err != nil {
		t.Errorf("File could not be opened")
	}
	obj, got := Parse(string(data))
...
func TestNestingTypesValid2(t *testing.T) {
	data, err := os.ReadFile("./step4/valid2.json")
	if err != nil {
		t.Errorf("File could not be opened")
	}
	obj, got := Parse(string(data))
	...
	fmt.Println(obj["innerkey"])
}

func TestNestingTypesInvalid(t *testing.T) {
	data, err := os.ReadFile("./step4/invalid.json")
	if err != nil {
		t.Errorf("File could not be opened")
	}
	obj, got := Parse(string(data))
